...
{club:"LIV",era:"10s",note:"Suárez → Klopp",players:[P("alisson","Alisson",["GK"],[],89,"sweeperk"),P("vvd","Virgil van Dijk",["CB"],[],90,"wall"),P("matip","Joël Matip",["CB"],[],82,"ballplayer"),P("robbo","Andrew Robertson",["LB"],[],84,"fullback"),P("taa","Trent Alexander-Arnold",["RB"],[],84,"fullback"),P("wijnaldum","Georginio Wijnaldum",["CM"],["CDM"],83,"box2box"),P("coutinho","Philippe Coutinho",["CAM"],["LW"],84,"magician"),P("suarez","Luis Suárez ('14)",["ST"],[],89,"complete"),P("salah","Mohamed Salah ('18)",["RW","ST"],[],89,"pace"),P("gakpo","Cody Gakpo",["LW"],["ST"],83,"pace"),P("mane","Sadio Mané",["LW","ST"],[],85,"pace"),P("firmino","Roberto Firmino",["ST","CAM"],[],83,"complete")]},
{club:"LIV",era:"20s",note:"Champions, then Slot",players:[P("alisson","Alisson ('22)",["GK"],[],89,"sweeperk"),P("vvd","Virgil van Dijk ('22)",["CB"],[],90,"wall"),P("konate","Ibrahima Konaté",["CB"],[],83,"wall"),P("taa","Trent Alexander-Arnold ('22)",["RB"],[],84,"fullback"),P("frimpong","Jeremie Frimpong ('25)",["RB","RWB"],[],83,"fullback"),P("macallister","Alexis Mac Allister",["CM"],["CDM"],84,"playmaker"),P("szoboszlai","Dominik Szoboszlai",["CM","CAM"],[],83,"box2box"),P("wirtz","Florian Wirtz ('25)",["CAM"],["LW"],87,"magician"),P("salah","Mohamed Salah ('22)",["RW"],["ST"],90,"pace"),P("diaz","Luis Díaz",["LW"],[],84,"pace"),P("jota","Diogo Jota",["ST","LW"],[],83,"poacher"),P("isak","Alexander Isak",["ST"],[],86,"complete"),P("ekitike","Hugo Ekitike",["ST"],[],82,"pace")]},
/* CHELSEA */
...
{club:"PSG",era:"20s",note:"Luis Enrique's UCL",players:[P("donnarumma","Gianluigi Donnarumma",["GK"],[],87,"keeper"),P("marquinhos","Marquinhos ('22)",["CB"],["CDM"],85,"sweeper"),P("pacho","Willian Pacho",["CB"],[],83,"wall"),P("hakimi","Achraf Hakimi",["RB","RWB"],[],84,"fullback"),P("nunomendes","Nuno Mendes",["LB","LWB"],[],84,"fullback"),P("sergioramos","Sergio Ramos ('22)",["CB"],[],84,"wall"),P("joaoneves","João Neves",["CM"],["CDM"],84,"box2box"),P("vitinha","Vitinha",["CM"],["CDM"],85,"playmaker"),P("doue","Désiré Doué",["CAM","RW"],[],83,"creator"),P("kvara","Khvicha Kvaratskhelia ('25)",["LW"],[],86,"magician"),P("barcola","Bradley Barcola",["LW","RW"],[],83,"pace"),P("gramos","Gonçalo Ramos",["ST"],[],82,"poacher"),P("mbappe","Kylian Mbappé ('23)",["ST","LW"],[],91,"pace")]},
/* BAYERN */
...
{club:"BVB",era:"10s",note:"Klopp's young guns",players:[P("weidenfeller","Roman Weidenfeller",["GK"],[],83,"keeper"),P("hummels","Mats Hummels",["CB"],[],87,"ballplayer"),P("subotic","Neven Subotić",["CB"],[],82,"wall"),P("schmelzer","Marcel Schmelzer",["LB"],[],80,"fullback"),P("piszczek","Łukasz Piszczek",["RB"],[],81,"fullback"),P("svenbender","Sven Bender",["CDM"],["CM"],81,"anchor"),P("sahin","Nuri Şahin",["CM"],["CDM"],82,"playmaker"),P("gundogan","İlkay Gündoğan ('15)",["CM"],["CAM"],85,"playmaker"),P("kuba","Jakub Błaszczykowski",["RM","RW"],[],81,"winger"),P("gotze","Mario Götze",["CAM"],["ST"],83,"creator"),P("reus","Marco Reus",["CAM","LW"],["ST"],86,"creator"),P("lewa","Robert Lewandowski ('13)",["ST"],[],86,"poacher"),P("aubameyang","Aubameyang ('16)",["ST"],["LW"],85,"pace"),P("sancho","Jadon Sancho",["RW"],["LW"],83,"winger")]},
