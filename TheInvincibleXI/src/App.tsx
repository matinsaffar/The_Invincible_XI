...
export default function App(){
  ...
  return(
    <div style={{width: "100%",maxWidth: 640,padding: "max(20px, env(safe-area-inset-top)) 24px max(24px, env(safe-area-inset-bottom))",display: "flex",flexDirection: "column",alignItems: "center",justifyContent: "center",boxSizing: "border-box",minHeight:"100dvh",color:t.text,fontFamily:"ui-sans-serif, system-ui, sans-serif",overflow:hidden;}}>
    {showIntro&&(
