...
{club:"ARS",era:"20s",note:"Arteta's rebuild",players:[P("raya","David Raya",["GK"],[],87,"sweeperk"),P("saliba","William Saliba",["CB"],[],85,"ballplayer"),P("gabriel","Gabriel Magalhães",["CB"],[],86,"wall"),P("calafiori","Riccardo Calafiori",["CB","LB"],[],83,"ballplayer"),P("hincapie","Piero Hincapié",["CB","LB"],[],82,"wall"),P("timber","Jurriën Timber",["RB","CB"],[],83,"fullback"),P("zubimendi","Martín Zubimendi",["CDM"],["CM"],84,"anchor"),P("rice","Declan Rice",["CDM","CM"],[],88,"anchor"),P("merino","Mikel Merino",["CM"],["CAM"],83,"box2box"),P("odegaard","Martin Ødegaard",["CAM"],["CM"],85,"playmaker"),P("saka","Bukayo Saka",["RW"],["LW"],87,"winger"),P("martinelli","Gabriel Martinelli",["LW"],["ST"],83,"pace"),P("gyokeres","Viktor Gyökeres",["ST"],[],85,"poacher")]},
/* MAN UNITED */
{club:"MUN",era:"90s",note:"Treble winners",players:[P("schmeichel","Peter Schmeichel",["GK"],[],90,"keeper"),P("stam","Jaap Stam",["CB"],[],88,"wall"),P("bruce","Steve Bruce",["CB"],[],82,"wall"),P("gneville","Gary Neville",["RB"],[],81,"fullback"),P("irwin","Denis Irwin",["LB"],["RB"],82,"fullback"),P("keane","Roy Keane",["CM","CDM"],[],85,"engine"),P("scholes","Paul Scholes",["CM"],["CAM"],86,"playmaker"),P("beckham","David Beckham",["RM","CM"],[],87,"winger"),P("giggs","Ryan Giggs",["LW","LM"],[],86,"winger"),P("cantona","Eric Cantona ('96)",["CF","ST"],[],88,"creator"),P("yorke","Dwight Yorke",["ST"],[],83,"poacher"),P("cole","Andy Cole",["ST"],[],84,"poacher"),P("sheringham","Teddy Sheringham",["ST","CF"],[],83,"creator")]},
{club:"MUN",era:"00s",note:"Ronaldo & Rooney",players:[P("vandersar","Edwin van der Sar",["GK"],[],88,"keeper"),P("ferdinand","Rio Ferdinand",["CB"],[],86,"ballplayer"),P("vidic","Nemanja Vidić",["CB"],[],85,"wall"),P("evra","Patrice Evra",["LB"],[],82,"fullback"),P("carrick","Michael Carrick",["CM","CDM"],[],82,"playmaker"),P("scholes","Paul Scholes ('07)",["CM"],["CAM"],86,"playmaker"),P("giggs","Ryan Giggs ('08)",["LW","LM"],[],84,"winger"),P("park","Ji-Sung Park",["LM","RM"],["CM"],80,"engine"),P("rooney","Wayne Rooney ('08)",["ST","CAM"],[],87,"complete"),P("tevez","Carlos Tévez",["ST"],[],84,"power"),P("cr7","Cristiano Ronaldo ('08)",["LW","ST"],["RW"],90,"complete",true)]},
...
{club:"ROM",era:"00s",note:"Il Capitano's scudetto",players:[P("antonioli","Francesco Antonioli",["GK"],[],81,"keeper"),P("samuel","Walter Samuel",["CB"],[],84,"wall"),P("emerson_r","Emerson",["CDM","CM"],[],83,"anchor"),P("totti","Totti ('04)",["CF","CAM"],["ST"],87,"creator"),P("montella","Vincenzo Montella",["ST"],[],82,"poacher"),P("batistuta","Gabriel Batistuta ('01)",["ST"],[],84,"power")]},
...
/* NAPOLI */
{club:"NAP",era:"80s",note:"Maradona's Napoli",players:[P("garella","Claudio Garella",["GK"],[],80,"keeper"),P("ferrara","Ciro Ferrara",["CB"],[],84,"wall"),P("denapoli","Fernando De Napoli",["CM"],["CDM"],80,"engine"),P("maradona","Diego Maradona",["CAM","CF"],["ST"],95,"magician",true),P("careca","Careca",["ST"],[],85,"pace"),P("giordano","Bruno Giordano",["ST"],[],82,"poacher")]},
...
{club:"MIL",era:"00s",note:"2007 kings of Europe",players:[P("dida","Dida",["GK"],[],85,"keeper"),P("nesta","Alessandro Nesta ('07)",["CB"],[],87,"wall"),P("maldini","Paolo Maldini ('05)",["CB","LB"],[],88,"ballplayer"),P("pirlo","Andrea Pirlo ('07)",["CDM","CM"],[],86,"playmaker"),P("gattuso","Gennaro Gattuso",["CDM"],["CM"],83,"anchor"),P("ambrosini","Massimo Ambrosini",["CM"],["CDM"],81,"engine"),P("seedorf","Clarence Seedorf",["CM","CAM"],[],85,"box2box"),P("kaka","Kaká",["CAM"],["CM"],90,"magician"),P("ronaldinho","Ronaldinho ('09)",["LW","CAM"],[],84,"magician"),P("beckham","David Beckham ('09)",["RM","CM"],[],83,"winger"),P("sheva","Andriy Shevchenko",["ST"],[],88,"complete"),P("pinzaghi","Filippo Inzaghi",["ST"],[],85,"poacher")]},
...
export default function App(){
  ...
  <div style={{minHeight:"100vh",width:"100%",color:t.text,fontFamily:"ui-sans-serif, system-ui, sans-serif",position:"relative",overflow:"hidden"}}>
    {showIntro&&(
      <div onClick={skipIntro} style={{position:"fixed",inset:0,zIndex:120,cursor:"pointer",background:"radial-gradient(circle at 50% 35%, #1b2247, #0a0e1f 70%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:mob?16:14,padding:"0 24px",textAlign:"center",opacity:introFade?0:1,transition:"opacity .55s ease"}}>
        <div style={{animation:"introUp .7s cubic-bezier(.2,.8,.2,1) both",lineHeight:0}}><svg width={mob?82:66} height={mob?91:73} viewBox="-4 -4 54 60" aria-hidden="true" style={{display:"block",overflow:"visible"}}><defs><linearGradient id="crestG" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#9b8cff"/><stop offset="1" stopColor="#5de0c4"/></linearGradient></defs><path d="M5 6 L41 6 L41 30 Q41 44 23 49 Q5 44 5 30 Z" fill="url(#crestG)" fillOpacity="0.16" stroke="url(#crestG)" strokeWidth="1.6" strokeLinejoin="round"/><circle cx="23" cy="24" r="11" fill="none" stroke="url(#crestG)" strokeWidth="1.5"/><path d="M23 13 L26.5 20.5 L18.5 20.5 Z M16 23 L19 31 L13.5 26 Z M30 23 L27 31 L32.5 26 Z" fill="url(#crestG)"/></svg></div>
        <div style={{fontSize:mob?62:52,fontWeight:900,letterSpacing:-1,lineHeight:1,background:"linear-gradient(135deg,#b4a8ff,#5de0c4)",WebkitBackgroundClip:"text",backgroundClip:"text",WebkitTextFillColor:"transparent",animation:"introUp .7s .08s both"}}>38-0</div>
        <div style={{fontSize:mob?12.5:14,fontWeight:700,color:"rgba(242,245,255,.7)",letterSpacing:mob?2:3,textTransform:"uppercase",animation:"introUp .7s .16s both"}}>Build the Invincibles</div>
        <div style={{marginTop:mob?16:22,display:"flex",alignItems:"center",gap:7,fontSize:mob?14.5:13.5,fontWeight:600,color:"rgba(242,245,255,.85)",animation:"introUp .7s .3s both"}}>Built with <span style={{display:"inline-flex",alignItems:"center",gap:4,fontWeight:800}}><svg width={mob?15:13} height={mob?17:15} viewBox="0 0 13 15" aria-hidden="true"><defs><linearGradient id="vit" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#41d1ff"/><stop offset="1" stopColor="#bd34fe"/></linearGradient><linearGradient id="vit2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffea83"/><stop offset="1" stopColor="#ffba27"/></linearGradient></defs><path d="M12.7 2.1 6.8 13.9c-.13.26-.5.26-.63 0L.2 2.1c-.14-.28.1-.6.41-.55l5.9 1.05c.04 0 .09 0 .13 0L12.3 1.55c.31-.06.55.27.41.55z" fill="url(#vit)"/><path d="M9.3 1.0 5.0 1.85c-.07.01-.12.07-.13.14l-.27 4.55c-.01.1.08.18.18.16l1.2-.28c.11-.03.21.08.18.19l-.36 1.74c-.03.12.08.22.19.18l.74-.22c.11-.03.22.07.19.19l-.57 2.74c-.04.18.2.28.3.12L7.0 10.7l2.74-5.47c.06-.12-.04-.25-.17-.23l-1.23.24c-.12.02-.22-.09-.18-.2l.8-2.78c.04-.12-.06-.23-.18-.2z" fill="url(#vit2)"/></svg>Vite</span></div>
        <div style={{fontSize:mob?13.5:13,fontWeight:700,color:"#b4a8ff",animation:"introUp .7s .42s both"}}>Created by Matin Saffar</div>
        <div style={{position:"absolute",bottom:30,fontSize:11,color:"rgba(242,245,255,.4)",animation:"introUp .7s .9s both"}}>tap to skip</div>
      </div>
    )}
    {oracleOpen&&oracle&&result&&(
      <div onClick={()=>setOracleOpen(false)} style={{position:"fixed",inset:0,zIndex:100,background:"rgba(6,10,20,.72)",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",display:"flex",alignItems:mob?"flex-end":"center",justifyContent:"center",padding:mob?0:"24px"}}>
        <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:470,maxHeight:mob?"88vh":"86vh",overflowY:"auto",WebkitOverflowScrolling:"touch",background:dark?"#111831":"#f5f8ff",border:"1px solid "+t.glassB,borderRadius:mob?"22px 22px 0 0":20,padding:mob?"18px 15px 26px":22,boxShadow:"0 -10px 50px rgba(0,0,0,.5)"}}>
          ...
          <div style={{display:"flex",gap:10,marginBottom:16}}>
            <div style={{flex:1,...glass,borderRadius:13,padding:"11px 13px"}}>
              ...
              <div style={{fontSize:19,fontWeight:900,color:t.text}}>{result.W}-{result.D}-{result.Lo}</div>
              <div style={{fontSize:12,color:t.sub}}>{result.pts} pts</div>
            </div>
            <div style={{flex:1,borderRadius:13,padding:"11px 13px",background:dark?"rgba(180,168,255,.12)":"rgba(107,79,255,.08)",border:"1px solid "+(dark?"rgba(180,168,255,.25)":"rgba(107,79,255,.2)")}}>
              <div style={{fontSize:10.5,color:accP,fontWeight:800,marginBottom:3,letterSpacing:.5}}>ORACLE'S BEST</div>
              <div style={{fontSize:19,fontWeight:900,color:t.text}}>{oracle.best.W}-{oracle.best.D}-{oracle.best.L}</div>
          ...
          <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr",gap:6,marginBottom:18}}>
            {oracle.best.a.xi.map(s=>{const p=s.player as Player;return(
              <div key={s.idx} style={{display:"flex",alignItems:"center",gap:8,...glass,borderRadius:10,padding:"7px 10px"}}>
                ...
                <span style={{fontSize:12,fontWeight:900,color:accT,flexShrink:0}}>{p.ov}</span>
              </div>
            );})}
          </div>
              ...
              {oracle.mistakes.slice(0,8).map((m,i)=>(
                <div key={i} style={{...glass,borderRadius:11,padding:"9px 12px"}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:7,fontSize:12.5,flexWrap:"wrap"}}>
                    ...
                    <span style={{color:t.text,fontWeight:800}}>{cn(m.better.n)} ({m.better.ov}){m.better.ic&&<span style={{color:accT}}> ★</span>}</span>
                  </div>
                </div>
              ))}
            </div>
    ...
    <div style={{position:"relative",zIndex:1,maxWidth:1100,margin:"0 auto",padding:"18px 16px 60px"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginBottom:18}}>
        <Logo size={mob?34:42}/>
        <div style={{display:"flex",gap:mob?7:8,flexShrink:0}}>
          {phase!=="menu"&&<button onClick={()=>setPhase("menu")} title="New game" style={{...glass,borderRadius:13,padding:mob?"10px":"9px 14px",color:t.text,fontSize:13,fontWeight:600,cursor:"pointer",display:"flex",alignItems:"center",gap:6,whiteSpace:"nowrap",flexShrink:0}}><RefreshCw size={mob?17:15}/>{!mob&&<span>New game</span>}</button>}
          <button onClick={()=>{const v=!soundOn;setSoundOn(v);sfx.setOn(v);}} title={soundOn?"Mute sounds":"Unmute sounds"} style={{...glass,borderRadius:13,padding:10,color:t.text,cursor:"pointer",display:"flex",flexShrink:0}}>{soundOn?<Volume2 size={17}/>:<VolumeX size={17}/>}</button>
          <button onClick={()=>setTheme(dark?"light":"dark")} style={{...glass,borderRadius:13,padding:10,color:t.text,cursor:"pointer",display:"flex",flexShrink:0}}>{dark?<Sun size={17}/>:<Moon size={17}/>}</button>
        </div>
      </div>
      ...
      <div style={{maxWidth:720,margin:"0 auto",display:"grid",gap:14}}>
        ...
        {oracle&&<button onClick={()=>setOracleOpen(true)} style={{width:"100%",...glass,borderRadius:16,padding:"12px 14px",display:"flex",alignItems:"center",gap:11,cursor:"pointer",textAlign:"left"}}>
          <div style={{width:34,height:34,borderRadius:10,background:dark?"rgba(180,168,255,.15)":"rgba(107,79,255,.1)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Wand2 size={17} style={{color:accP}}/></div>
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:13.5,fontWeight:800,color:t.text}}>Oracle Analysis</div>
            <div style={{fontSize:11.5,color:t.sub,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{oracle.mistakes.length?oracle.mistakes.length+" upgrade"+(oracle.mistakes.length>1?"s":"")+" available · best XI · best formation":"Your best XI · best formation"}</div>
          </div>
          <ChevronDown size={18} style={{color:t.sub,flexShrink:0,transform:"rotate(-90deg)"}}/>
        </button>}
