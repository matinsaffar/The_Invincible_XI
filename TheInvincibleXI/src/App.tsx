...
export default function App(){
  ...
  return(
    <div style={{width: "100%",maxWidth: 640,padding: "max(20px, env(safe-area-inset-top)) 24px max(24px, env(safe-area-inset-bottom))",display: "flex",flexDirection: "column",alignItems: "center",justifyContent: "center",boxSizing: "border-box",minHeight:"100dvh",color:t.text,fontFamily:"ui-sans-serif, system-ui, sans-serif"}}>
    {showIntro&&(
      <div onClick={skipIntro} style={{position:"fixed",inset:0,zIndex:120,cursor:"pointer",background:"radial-gradient(circle at 50% 35%, #1b2247, #0a0e1f 70%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap: "clamp(8px, 2vh, 18px)",opacity:introFade?0:1,transition:"opacity .55s ease"}}>
        <div style={{animation:"introUp .7s cubic-bezier(.2,.8,.2,1) both"}}><svg width="clamp(48px, 14vw, 80px)" height="clamp(53px, 15.5vw, 88px)" viewBox="0 0 46 52" aria-hidden="true"><defs><linearGradient id="crestG" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#9b8cff"/><stop offset="1" stopColor="#5de0c4"/></linearGradient></defs><path d="M5 6 L41 6 L41 30 Q41 44 23 49 Q5 44 5 30 Z" fill="url(#crestG)" fillOpacity="0.16" stroke="url(#crestG)" strokeWidth="1.6"/><circle cx="23" cy="24" r="11" fill="none" stroke="url(#crestG)" strokeWidth="1.5"/><path d="M23 13 L26.5 20.5 L18.5 20.5 Z M16 23 L19 31 L13.5 26 Z M30 23 L27 31 L32.5 26 Z" fill="url(#crestG)"/></svg></div>
        <div style={{fontSize:'clamp(36px, 12vw, 72px)',fontWeight:900,letterSpacing:'clamp(2px, 1vw, 8px)',background:"linear-gradient(135deg,#b4a8ff,#5de0c4)",WebkitBackgroundClip:"text",backgroundClip:"text",WebkitTextFillColor:"transparent",animation:"introUp .7s .08s both"}}>38-0</div>
        <div style={{fontSize:'clamp(10px, 3vw, 15px)',fontWeight:700,color:"rgba(242,245,255,.7)",letterSpacing:'clamp(2px, 1.5vw, 5px)',textTransform:"uppercase",animation:"introUp .7s .16s both"}}>Build the Invincibles</div>
        <div style={{marginTop:"clamp(12px,3vh,26px)",display:"flex",alignItems:"center",gap:7,fontSize:13.5,fontWeight:600,color:"rgba(242,245,255,.85)",animation:"introUp .7s .3s both"}}>Built with <span style={{display:"inline-flex",alignItems:"center",gap:4,fontWeight:800}}><svg width="13" height="15" viewBox="0 0 13 15" aria-hidden="true"><defs><linearGradient id="vit" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#41d1ff"/><stop offset="1" stopColor="#bd34fe"/></linearGradient><linearGradient id="vit2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffea83"/><stop offset="1" stopColor="#ffba27"/></linearGradient></defs><path d="M12.7 2.1 6.8 13.9c-.13.26-.5.26-.63 0L.2 2.1c-.14-.28.1-.6.41-.55l5.9 1.05c.04 0 .09 0 .13 0L12.3 1.55c.31-.06.55.27.41.55z" fill="url(#vit)"/><path d="M9.3 1.0 5.0 1.85c-.07.01-.12.07-.13.14l-.27 4.55c-.01.1.08.18.18.16l1.2-.28c.11-.03.21.08.18.19l-.36 1.74c-.03.12.08.22.19.18l.74-.22c.11-.03.22.07.19.19l-.57 2.74c-.04.18.2.28.3.12L7.0 10.7l2.74-5.47c.06-.12-.04-.25-.17-.23l-1.23.24c-.12.02-.22-.09-.18-.2l.8-2.78c.04-.12-.06-.23-.18-.2z" fill="url(#vit2)"/></svg>Vite</span></div>
        <div style={{fontSize:'clamp(13px, 3.5vw, 16px)',fontWeight:700,color:"#b4a8ff",animation:"introUp .7s .42s both"}}>Created by Matin Saffar</div>
